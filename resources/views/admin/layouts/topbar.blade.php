        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('admin.dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset ('admin-panel/assets/images/logo.svg') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('admin-panel/assets/images/logo-dark.png') }}" alt="" height="17">
                    </span>
                </a>

                <a href="{{ route('admin.dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ URL::asset ('admin-panel/assets/images/logo_sm.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('admin-panel/assets/images/logo.png') }}" alt="" height="46">
                    </span>
                </a>
            </div>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                ...
                <div data-simplebar style="max-height: 230px;">
                    ...
                    <a href="" class="text-reset notification-item">
                        <div class="media">
                            <img src="{{ URL::asset ('admin-panel/assets/images/users/avatar-3.jpg') }}"
                    ...
                    <a href="" class="text-reset notification-item">
                        <div class="media">
                            <img src="{{ URL::asset ('admin-panel/assets/images/users/avatar-4.jpg') }}"
                                class="me-3 rounded-circle avatar-xs" alt="user-pic">
                            <div class="media-body">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" src="{{ asset('admin-panel/assets/images/users/avatar-0.jpg') }}"
                    alt="Header Avatar">
            ...
            <div class="modal-body">
                <form method="POST" id="change-password">
                    ...
                    <div class="mt-3 d-grid">
                        <a href="#" class="btn btn-primary waves-effect waves-light">Update Password</a>
                    </div>
                </form>
            </div>
        </div><!-- /.modal-content -->
