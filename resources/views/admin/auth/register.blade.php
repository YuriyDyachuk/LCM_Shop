...
@section('css')
    <!-- owl.carousel css -->
    <link rel="stylesheet" href="{{ URL::asset('admin-panel/assets/libs/owl.carousel/owl.carousel.min.css') }}">
    <link href="{{ URL::asset('admin-panel/assets/libs/bootstrap-datepicker/bootstrap-datepicker.min.css') }}" rel="stylesheet" type="text/css">
@endsection
...
@section('body')
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="{{ route('admin.dashboard') }}" class="d-block auth-logo">
                                            <img src="{{ URL::asset('admin-panel/assets/images/logo-dark.png') }}" alt="" height="18"
                                                class="auth-logo-dark">
                                            <img src="{{ URL::asset('admin-panel/assets/images/logo-light.png') }}" alt="" height="18"
    ...
    @section('script')
        ...
        <!-- owl.carousel js -->
        <script src="{{ URL::asset('admin-panel/assets/libs/owl.carousel/owl.carousel.min.js') }}"></script>
        <!-- auth-2-carousel init -->
        <script src="{{ URL::asset('admin-panel/assets/js/pages/auth-2-carousel.init.js') }}"></script>
    @endsection
